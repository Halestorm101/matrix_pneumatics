					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="entry-content clearfix">
							...
							<div class="photometa clearfix">
								<div class="EXIF">
									<h4><?php _e( 'Image Data', 'it-l10n-Builder-Summit' ); ?></h4>
									...
									<?php if ( is_attachment() ) : ?>
										<?php
											...
											$meta_fields = array(
												'camera'            => __( 'Camera', 'it-l10n-Builder-Summit' ),
												'created_timestamp' => __( 'Date Taken', 'it-l10n-Builder-Summit' ),
												'aperture'          => __( 'Aperture', 'it-l10n-Builder-Summit' ),
												'focal_length'      => __( 'Focal Length', 'it-l10n-Builder-Summit' ),
												'iso'               => __( 'ISO', 'it-l10n-Builder-Summit' ),
												'shutter_speed'     => __( 'Shutter Speed', 'it-l10n-Builder-Summit' ),
												'credit'            => __( 'Credit', 'it-l10n-Builder-Summit' ),
												'copyright'         => __( 'Copyright', 'it-l10n-Builder-Summit' ),
												'title'             => __( 'Title', 'it-l10n-Builder-Summit' ),
											);
										?>
										
										<table>
											<tr>
												<th scope="row"><?php _e( 'Dimensions', 'it-l10n-Builder-Summit' ); ?></th>
