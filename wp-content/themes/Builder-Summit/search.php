...
?>
	<div class="loop">
		<div class="loop-header">
			<h4 class="loop-title">
				<?php
					$title = sprintf( __( 'Search Results for "<em>%s</em>"', 'it-l10n-Builder-Summit' ), get_search_query() );
						...
						<div class="entry-header clearfix">
							...
							<?php if ( 'page' !== $GLOBALS['post']->post_type ) : ?>
								<div class="entry-meta">
									...
									<?php do_action( 'builder_comments_popup_link', '<span class="comments">&middot; ', '</span>', __( 'Comments %s', 'it-l10n-Builder-Summit' ), __( '(0)', 'it-l10n-Builder-Summit' ), __( '(1)', 'it-l10n-Builder-Summit' ), __( '(%)', 'it-l10n-Builder-Summit' ) ); ?>
								</div>
						...
						<?php if ( 'page' !== $GLOBALS['post']->post_type ) : ?>
							...
							<div class="entry-footer clearfix">
								...
								<div class="entry-meta alignleft">
									<div class="categories"><?php printf( __( 'Categories : %s', 'it-l10n-Builder-Summit' ), get_the_category_list( ', ' ) ); ?></div>
			...
			<?php else : // do not delete ?>
				<div class="hentry">
					<div class="entry-content">
						<p><?php _e( 'No results found.', 'it-l10n-Builder-Summit' ); ?></p>
