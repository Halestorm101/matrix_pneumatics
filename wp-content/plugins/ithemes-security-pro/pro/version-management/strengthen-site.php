...
<?php
	...
	public static function login_form_validate_unlock_code() {
		...
		if ( ! self::is_code_valid( $user, $_POST['authcode'] ) ) {
			add_filter( 'itsec-filter-failed-login-details', array( __CLASS__, 'filter_failed_login_details' ) );
...
<?php
	...
	public static function filter_failed_login_details( $details ) {
		$details['authentication_types'] = array( __( 'version_management_two_factor', 'it-l10n-ithemes-security-pro' ) );
